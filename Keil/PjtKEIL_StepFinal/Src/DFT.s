...
DFT_ModuleAuCarre proc
	push {r4, r5, r6, r7, r8}
	mov r2, #0 ;compteur n
	mov r7, #0 ; initialisation partie réelle
	mov r8, #0 ; initialisation partie imaginaire

	;mov r3, #0
	;r0: tableau x(n)
	;r1: k
	;r2: n
	;r3: p=k*n modulo 64 au début
	;r4: x(n)
	;r5: valeur du cos dans un premier temps, puis du sin
	;r6: adresse du tableau des cos, puis des sin
boucle
	mul r3, r2, r1 ; p = k*n
	and r3, #63 ; p mod 64
	...
	smull r0, r1, r7, r7
	smlal r0, r1, r8, r8 ; sortie au format 16.48
	pop {r4, r5, r6, r7, r8}
